...
def run(args):
    ...
    outputDir = jsonAsrResultsDir.replace('json-asr-results', 'fluency-features')
    ...
    for jsonAsrResult in jsonAsrResultsList:
        ...
        basename = os.path.basename(jsonAsrResult)
    ...
    outputFile = os.path.join(outputDir, 'json-asr-results-fluency-features.tsv')
